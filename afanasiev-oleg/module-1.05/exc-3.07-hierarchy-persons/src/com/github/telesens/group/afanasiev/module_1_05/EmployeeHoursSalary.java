...
public class EmployeeHoursSalary extends Employee {
    ...
    public EmployeeHoursSalary(String firstName, String lastName, Gender gender, String country, String company, String position, double payByHour) {
        super(firstName, lastName, gender, country, company, position);
    ...
    public EmployeeHoursSalary(Citizen citizen, String company, String position, double payByHour) {
        super(citizen.getFirstName(), citizen.getLastName(), citizen.getGender(), citizen.getCountry(), company, position);
        this.payByHour = payByHour;
    }
